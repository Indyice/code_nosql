            ...
            <div class="modal-body p-0">
                <div class="card card-plain">
                    <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-info text-gradient">Create Activity</h3>
                    </div>
                    <div class="card-body">
                        ...
                        <form role="form text-left">
                            ...
                            <label>Point</label>
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="point" name="act_point" value="<?php echo isset($act)?$act->act_point:set_value('act_point'); ?>">
                            </div>
